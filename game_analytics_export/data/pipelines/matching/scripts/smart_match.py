...
from config import MASTER_JSON, MATCHING_DIR, RULES_TEXT_DIR

GAMES_PATH = MASTER_JSON
RULES_INDEX_PATH = MATCHING_DIR / "rules_index.json"
EXISTING_MATCHES_PATH = MATCHING_DIR / "rules_game_matches.json"
OUTPUT_PATH = MATCHING_DIR / "rules_game_matches.json"
REJECTIONS_PATH = MATCHING_DIR / "rules_match_rejections.json"
TEXT_DIR = RULES_TEXT_DIR
...
FUZZY_CANDIDATES_PATH = MATCHING_DIR / "rules_fuzzy_candidates.json"
