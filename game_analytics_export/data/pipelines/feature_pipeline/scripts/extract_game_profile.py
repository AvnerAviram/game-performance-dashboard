...
from config import DATA_DIR, ENV_FILE, MASTER_JSON, MATCHING_DIR, STAGING_DIR, VALIDATION_DIR

RULES_HTML_DIR = MATCHING_DIR / "rules_html"
MASTER_PATH = MASTER_JSON
GT_PATH = VALIDATION_DIR / "ground_truth_ags.json"
MATCHES_PATH = MATCHING_DIR / "rules_game_matches.json"
...
ART_STAGED_PATH = STAGING_DIR / "staged_art_characterization.json"
