 ...
 * picks the best gameplay screenshot per game, and downloads to data/screenshots/.
 *
 * Usage:
...
const { DATA_DIR, SCREENSHOTS_DIR } = require('../../../../src/lib/data-paths.cjs');

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const SC_DIR = path.join(DATA_DIR, '_legacy', 'sc_cache');
