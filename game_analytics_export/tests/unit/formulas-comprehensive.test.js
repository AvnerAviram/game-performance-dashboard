...
describe('Smart Index Formula', () => {
  ...
  test('should handle zero game count', () => {
    const avgTheoOverall = 10;
    const items = [
      { theme: 'Zero', game_count: 0, avg_theo_win: 15 }
    ];
  ...
  test('should handle one game', () => {
    const avgTheoOverall = 10;
    const items = [
      { theme: 'One', game_count: 1, avg_theo_win: 20 }
    ];
  ...
  test('should handle large game count (1000 games)', () => {
    const avgTheoOverall = 10;
    const items = [
      { theme: 'Large', game_count: 1000, avg_theo_win: 10 }
    ];
  ...
  test('should handle very high avg theo_win', () => {
    const avgTheoOverall = 10;
    const items = [
      { theme: 'HighPerf', game_count: 25, avg_theo_win: 50 }
    ];
  ...
  test('should handle very low avg theo_win', () => {
    const avgTheoOverall = 10;
    const items = [
      { theme: 'LowPerf', game_count: 100, avg_theo_win: 1 }
    ];
  ...
  test('should handle floating point precision', () => {
    ...
    const items = [
      { theme: 'Precise', game_count: 47, avg_theo_win: 13.7891 }
    ];
...
describe('Market Share Calculations', () => {
  ...
  test('market share should not be NaN', () => {
    const themes = [
      { theme: 'Test', total_market_share: 5.5 }
    ];
...
describe('Edge Cases', () => {
  test('division by zero should be handled', () => {
    ...
    const items = [
      { theme: 'Test', game_count: 100, avg_theo_win: 15 }
    ];
    
    // Should not throw error
    const result = items.map(item => {
      const weight = Math.sqrt(item.game_count);
      const smartIndex = avgTheoOverall !== 0 
        ? (item.avg_theo_win * weight) / avgTheoOverall 
        : 0;
  ...
  test('extreme values should not produce Infinity', () => {
    ...
    const items = [
      { theme: 'Extreme', game_count: 1000000, avg_theo_win: 1000 }
    ];
  ...
  test('negative values should be handled', () => {
    ...
    const avgTheoOverall = 10;
    const items = [
      { theme: 'Negative', game_count: -10, avg_theo_win: 15 }
    ];
