...
describe('Theme Clickability - All Themes', () => {
    ...
    it('all themes should have valid game counts', () => {
        gameData.themes.forEach(theme => {
            ...
            expect(gameCount).toBeLessThan(500); // Sanity check - no theme should have 500+ games
        });
    });
    ...
    it('consolidated themes game counts should match sum of sub-themes', () => {
        ...
        consolidatedThemes.forEach(theme => {
            ...
            const subThemesSum = Object.values(theme._subthemes).reduce((sum, sub) => sum + sub['Game Count'], 0);
    ...
    it('key consolidated themes should exist', () => {
        const expectedConsolidated = ['Animals', 'Asian', 'Money/Luxury', 'Ancient Civilizations', 'Cultural/Regional'];
