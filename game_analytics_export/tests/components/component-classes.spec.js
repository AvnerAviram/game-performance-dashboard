...
test.describe('Component Classes Tests', () => {
  test('Page containers use correct component classes', async ({ page }) => {
    ...
    const allPages = ['overview', 'themes', 'mechanics', 'games', 'providers', 'anomalies', 'insights', 'trends', 'prediction', 'ai-assistant'];
  ...
  test('No CSS conflicts or !important rules', async ({ page }) => {
    ...
    const oldCssFiles = ['layout-fixes.css', 'essential-components.css', 'comprehensive-fixes-v178.css', 'dark-mode-fixed.css', 'modern-layout.css'];
